...
import { ArrowRight, MessageCircleHeart, Play, TicketPlus } from 'lucide-react';
           ...
           <div className="relative group w-52 h-auto">
             <div className="relative w-full h-full overflow-hidden">
               ...
               <Image
                 ...
                 width={208}
                 height={277}
                 className="w-full h-auto transition-transform transform group-hover:scale-110 duration-300 ease-in-out"
               />
 
               {/* Nền và các nút */}
               <div
                 className="absolute top-[60%] left-0 right-0 w-full transform translate-y-full group-hover:translate-y-0 group-hover:scale-110 transition-all duration-500 bg-theme"
                 style={{ height: '40%' }}
               >
                 ...
                 {/* Mô tả phim */}
                 <div className="text-[10px] mt-2 group-hover:opacity-100 transition-opacity duration-300 px-3">
                   <p className="line-clamp-3">
                     Mô tả của bộ phim mà người dùng muốn xem mô tả này sẽ dài tới đây, nếu quá dài sẽ có dấu ba chấm...zzzzzzsdasd
                   </p>
                   <Link href="/" className="text-[#228EE5] text-[12px] inline-flex items-center gap-1 hover:text-[#1A7DCC]">
